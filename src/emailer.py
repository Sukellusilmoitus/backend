...
class Emailer:
    def __init__(self, days, send_service, dive_model, targetnote_model):
    ...
    def send_email(self):
        ...
        self.send_service(message.as_string())
